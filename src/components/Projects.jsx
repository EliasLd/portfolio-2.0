...
export default function Projects() {
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-4 mb-10' id='projects'>
      <div className='mb-16'>
      ...
      <motion.div 
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 p-4 gap-2 bg-slate-700 relative lg:w-144 sm:w-128 rounded-3xl mx-4 sm:mx-0'>
