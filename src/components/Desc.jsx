  ...
  return (
    <div className='p-3 flex flex-col justify-center items-center mt-20'>
        ...
        <div className='p-4 flex  mt-5'>
            <p className='font-inter font-semibold text-sm text-slate-400'>Currently following an engineering program at 
            <a href='https://www.esilv.fr' className='px-1 mx-2 bg-sky-700 rounded-full text-white'>  ESILV  </a>, Paris. <br/> 
